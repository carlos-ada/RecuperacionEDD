...
class Prueba4 extends Prueba0{
	...
	@DisplayName(value = "Con valor limite inferior -1")
	@Test
	...
	@Test
	//En esta prueba hacemos la media de las notas del 2º trimestre en el que nos deberia salir de media un Bien
	void test5funcion4() {
	...
	@Test
	//En esta prueba hacemos la media de las notas del 2º trimestre en el que en algunos he bajado nota pero otras he subido, deberia dar una media de Notable
	void test6funcion4() {
	...
	@Test
	//En esta prueba hacemos la media de las notas del 2º trimestre en el que practicamente todo estaria suspenso, deberia devolver Insuficiente
	void test7funcion4() {
	...
	@Test
	//En esta prueba hacemos la media de las notas en negativo, pero como no existe una nota negativa nos devuelve null
	void test8funcion4() {
